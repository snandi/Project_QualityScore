...
## $python 3D_mole_region.py IntervalNum GroupNum MoleculeNum
...
def main(argv):
	...
	molecule_file = os.path.join(Input_MoleParentFolder, IntervalName, GroupName, MoleculeName)
...
#		ax.zaxis.set_majot_formatter(FormatStrFormatter('%.02f'))
		...
		Title = "interval" + str(IntervalNum) + "_Group" + str(GroupNum) + "_Molecule" + str(MoleculeNum) + "_intensity_distribution"
		plt.title(Title)
